  ...
  render() {    
    ...
    const looping = this.state.products.map((prod, index) => {
      return(
        <Row>
          <Col xs="6" key={index} >          
            <Card class="p-2 w-100 bd-highlight" className="PartCardArticleCardp2"> 
              <CardBody>
                <CardSubtitle>   
                  <Media>
                    ...
                    <Media body>
                      <Media heading className="PageDetailArticleMeidaNama"> Nama</Media>
                      <small className="text-muted">Last updated 3 mins ago</small>
                    </Media>
                    <Media> <CardImg  src={Tiga} className="PartCardArticle"/><Media  />
                    </Media>
                  </Media>
                </CardSubtitle>
              </CardBody>
              ...
              <CardBody>
                <CardTitle className="PartCardCategories"> {prod.categories}</CardTitle>
                <CardSubtitle className="PartCardContent" >{prod.content}</CardSubtitle>
              </CardBody>
            </Card>
          </Col>
        </Row>
      ...
      <div >
        ...
        <div className="BodyDefault" style={{ marginBottom:'30px'}}>
          <Row className="PartCardRow" >
            <Col style={{margin:'auto'}}>
              <Media>
                <Media>
                  <CardImg className="PartCardImg" src="https://scontent.fcgk8-2.fna.fbcdn.net/v/t1.0-9/37228699_10156511912949419_5427734426052198400_n.jpg?_nc_cat=106&_nc_eui2=AeFbW0UNjyUU6wUYr2IRN9OeP8hreReeKw5JhLn4zpkqOk1EoX7p-oyHW8DTrHt5IrPnY0tK6xlY0Q6fIY6iv9XgAzUKHS8I46Du69aZ0qCGvQ&_nc_ht=scontent.fcgk8-2.fna&oh=c180ed12f4d6e241827c9bed4879df13&oe=5D034823"/>
                  <Media  />
                </Media>
                <Media body>
        ...
        <Container >
          <Row className="PartCardRow2" >
              <Col xs="6" className="PartCardColx6" ><Link to='/profilearticle'>Article</Link></Col>
              <Col xs="6" className="PartCardColx6" ><Link to='/profileevent'>Event</Link></Col>
            </Row>
          <Row className='d-flex' style={{margin:'1px'}}>{looping}</Row>
        </Container>
        </div>
       <AppFooter/>
      </div>
